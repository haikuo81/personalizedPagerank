...
+ * The complexity is O(I *|Edges| * L).
  */
public class GuerrieriRankLocal extends PersonalizedPageRankAlgorithm
{
     ...
     */
    public GuerrieriRankLocal(final DirectedGraph<Integer, DefaultEdge> g, final int smallTop, 
     ...
     */
    @Override
    public GuerrieriRankLocal.GuerrieriParameters getParameters()
    {
        return parameters;
    }
