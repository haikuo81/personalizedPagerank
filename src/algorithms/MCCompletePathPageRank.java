 ...
 * from scores(X).
 */
public class MCCompletePathPageRank extends PersonalizedPageRankAlgorithm
{
    /*
    ...
    */
     ...
     */
    @Override
    public MCCompletePathPageRank.MCCompletePathParameters getParameters()
    {
        return parameters;
    }
    ...
    private void run()
    {
        ...
        */
        ...
        for(int node: g.vertexSet())
        {
            ...
            map.put(node, parameters.getIterations());
