...
public class MCCompletePathV2Test extends TestCase
{
    public void testBadConstructorsParameters()
    {
        ...
        try 
        {
            new MCCompletePathPageRankV2(g, 0, 1000, 0.85);
        ...
        try 
        {
            new MCCompletePathPageRankV2(g, 10, 0, 0.85);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
        ...
        try 
        {
            new MCCompletePathPageRankV2(g, 10, 100, -0.01);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
        ...
        try 
        {
            new MCCompletePathPageRankV2(g, 10, 100, 1d);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
        ...
        try 
        {
            new MCCompletePathPageRankV2(g, 10, 100, 1.1);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
    ...
    public void testGetters()
    {
        ...
        PersonalizedPageRankAlgorithm res = new MCCompletePathPageRankV2(g, 10, 1000, 0.85);
    ...
    public void testReturning0()
    {
        ...
        g.addVertex(1);
        g.addVertex(2);
        PersonalizedPageRankAlgorithm res = new MCCompletePathPageRankV2(g, 3, 1000, 0.85);
    ...
    public void testNoEdgesGraph()
    {
        ...
        PersonalizedPageRankAlgorithm res = new MCCompletePathPageRankV2(g, 100, 1000, 0.85);
        for(int i = 0 ; i < 1000; i++)
        {
            assertEquals(res.getMap(i).size(), 1);        
            assertEquals(res.getMap(i).get(i), 1d);
        }
    }
    ...
    public void testEdgeToHimself()
    {
        ...
        {
            assertEquals(res.getMap(i).size(), 1);        
            assertTrue(res.getMap(i).get(i) >= 1);
        }
    }
    ...
    public void testL()
    {
        ...
        for(int i = 1; i < 30; i++)
        {
            res = new MCCompletePathPageRankV2(g, i, 1000, 0.85);
            for(int u = 0; u < 30; u++)
    ...
    public void testSingleNodeGraph()
    {
        ...
        //1 node no edges
        g.addVertex(1);
        PersonalizedPageRankAlgorithm res = new MCCompletePathPageRankV2(g, 100, 100, 0.85);
    ...
    public void testTwoNodesGraph()
    {
        ...
        res = new MCCompletePathPageRankV2(g, 100, 100, 0.85);
    ...
    public void testNodesGreaterThanK1()
    {
        ...
        for(int i = 0; i < 99; i++)
            g.addEdge(i, i + 1);
        g.addEdge(99, 0);
        PersonalizedPageRankAlgorithm res = new MCCompletePathPageRankV2(g, K, 1000, 0.85);
    ...
    public void testNodesGreaterThanK4()
    {
        ...
        for(int i = 0; i < 99; i++)
            g.addEdge(i, i + 1);
        g.addEdge(99, 0);
        PersonalizedPageRankAlgorithm res = new MCCompletePathPageRankV2(g, g.vertexSet().size() * 2, 1000, 0.85);
        g.addVertex(1000);
