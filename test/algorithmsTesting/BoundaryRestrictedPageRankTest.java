...
public class BoundaryRestrictedPageRankTest extends TestCase
{
    public void testBadConstructorsParameters()
    {
        ...
        try 
        {
            new BoundaryRestrictedPageRank(g, 0, 50, 0.85, 0.0001, 0.001);
        ...
        try 
        {
            new BoundaryRestrictedPageRank(g, 100, 0, 0.85, 0.0001, 0.001);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
        ...
        try 
        {
            new BoundaryRestrictedPageRank(g, 100, 100, -0.1d, 0.0001, 0.001);     
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
        ...
        try 
        {
            new BoundaryRestrictedPageRank(g, 100, 100, 1.1d, 0.0001, 0.001);     
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
    ...
    public void testGetters()
    {
        ...
        PersonalizedPageRankAlgorithm res = new BoundaryRestrictedPageRank(g, 100,  100, 0.85, 0.0001, 0.001);
    ...
    public void testSingleNodeGraph()
    {
        ...
        g.addEdge(1, 1);
        res = new BoundaryRestrictedPageRank(g, 100,  100, 0.85, 0.0001, 0.001);
        assertEquals(res.getMaps().size(), 1, 0);
        assertEquals(res.getMap(1).size(), 1, 0);
    ...
    public void testTwoNodesGraph()
    {
        ...
        //no edges first
        PersonalizedPageRankAlgorithm res = new BoundaryRestrictedPageRank(g, 100,  100, 
                0.85, 0.001, 0.001);
    ...
    public void testStarGraph()
    {
        ...
        PersonalizedPageRankAlgorithm res = new BoundaryRestrictedPageRank(g, 100,  100, 0.8, 0.0001, 0.001);
    ...
    public void testNodesGreaterThanK1()
    {
        ...
        for(int i = 0; i < 99; i++)
            g.addEdge(i, i + 1);
        g.addEdge(99, 0);
        PersonalizedPageRankAlgorithm res = new BoundaryRestrictedPageRank(g, 100,  100, 0.85, 0d, 0d);
