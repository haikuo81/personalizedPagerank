...
public class ComparisonDataTest extends TestCase
{
    public void testConstructorAndGetters()
    {
        ...
        assertSame(r3, data.getSpearman());
    ...
    public void testDataNotModified()
    {
        ...
        assertEquals(data.getSpearman().getMin(), 0, 0);
        assertEquals(data.getSpearman().getAverage(), 1, 0);
        assertEquals(data.getSpearman().getMax(), 2, 0);
        assertEquals(data.getSpearman().getStd(), 3d, 0);
    }
    ...
    public void testEquals()
    {
        ...
        Parameters p1 = new Parameters(0, 1, 2, 3d, 4d);
        Parameters p2 = new Parameters(0, 1, 2, 3d, 4d);
        ComparisonData d1 = new ComparisonData(10, r1, r2, r3, p1, p2);
        ComparisonData d2 = new ComparisonData(10, r1, r2, r3, p1, p2);
        ...
        in[0] = 1d;
        r1 = new Result(in);
        d2 = new ComparisonData(10, r1, r2, r3, p1, p2);
