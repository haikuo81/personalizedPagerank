...
public class WrappedStoringPageRankTest extends TestCase
{
    ...
    public void testBadConstructorsParameters()
    {
        ...
        try
        {
            new WrappedStoringPageRank(g, 100, -1d, 0, 10);
        ...
        try 
        {
            new WrappedStoringPageRank(g, 100, 1.1, 0.0001, 10);
            fail("this line shouldn't be reached");
        ...
        try 
        {
            new WrappedStoringPageRank(g, 0, 0.85, 0.0001, 10);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
        ...
        try 
        {
            new WrappedStoringPageRank(g, 10, 0.5, 0.0, -1);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
    ...
    public void testGetters()
    {
        ...
        PersonalizedPageRankAlgorithm res = new WrappedStoringPageRank(g, 10, 0.5, 0.0001, 1);
    ...
    public void testEmptyGraph()
    {
        ...
        PersonalizedPageRankAlgorithm res = new WrappedStoringPageRank(g, 10, 0.5, 0.0001, 0);
    ...
    public void testSingleNodeGraph()
    {
        ...
        g.addEdge(1, 1);
        res = new WrappedStoringPageRank(g, 10, 0.5, 0.0001, 1);
        assertEquals(res.getMaps().size(), 1, 0);
        assertEquals(res.getMap(1).size(), 1, 0);
    ...
    public void testTwoNodesGraph()
    {
        ...
        //no edges first
        PersonalizedPageRankAlgorithm res = new WrappedStoringPageRank(g, 10, 0.85, 0.0001, 2);
        ...
        res = new WrappedStoringPageRank(g, 10, 0.85, 0.0001, 2);
    ...
    public void testLineGraph()
    {
        ...
        PersonalizedPageRankAlgorithm res = new WrappedStoringPageRank(g, 50, 0.85, 0.0001, 6);
    ...
    public void testStarGraph()
    {
        ...
        PersonalizedPageRankAlgorithm res = new WrappedStoringPageRank(g, 50, 0.8, 0.0001, 6);
        ...
        g.addEdge(0, 0);
        res = new WrappedStoringPageRank(g, 10, 0.8, 0.0001, 6);
    ...
    public void testResultEqualToPageRank()
    {
        ...
        WrappedStoringPageRank wr = new WrappedStoringPageRank(g, 100, 0.5, 0.0001, g.vertexSet().size());
