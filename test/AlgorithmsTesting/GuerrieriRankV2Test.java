...
public class GuerrieriRankV2Test extends TestCase
{
    public void testBadConstructorsParameters()
    {
        ...
        try 
        {
            new GuerrieriRankV2(g, 0, 10, 100, 0.8, 0.001);
        ...
        try 
        {
            new GuerrieriRankV2(g, 10, 5, 100, 0.8, 0.001);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
        ...
        try 
        {
            new GuerrieriRankV2(g, 10, 5, 0, 0.8, 0.001);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
        ...
        try 
        {
            new GuerrieriRankV2(g, 10, 5, 0, -0.1, 0.001);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
        ...
        try 
        {
            new GuerrieriRankV2(g, 10, 5, 0, 1.1, 0.001);
            fail("this line shouldn't be reached");
        } 
        catch (IllegalArgumentException e) {}
    ...
    public void testGetters()
    {
        ...
        PersonalizedPageRankAlgorithm res = new GuerrieriRankV2(g, 10, 30, 100, 0.85, 0.0001);
    ...
    public void testReturning0()
    {
        ...
        g.addVertex(1);
        g.addVertex(2);
        PersonalizedPageRankAlgorithm res = new GuerrieriRankV2(g, 3, 3, 100, 0.85, 0.0001);
    ...
    public void testL()
    {
        ...
        for(int i = 1; i < 30; i++)
        {
            res = new GuerrieriRankV2(g, i, i, 100, 0.85, 0.0001);
            for(int u = 0; u < 30; u++)
    ...
    public void testSingleNodeGraph()
    {
        ...
        //1 node no edges
        g.addVertex(1);
        PersonalizedPageRankAlgorithm res = new GuerrieriRankV2(g, 10, 10, 10, 0.5, 0.0001);
        ...
        g.addEdge(1, 1);
        res = new GuerrieriRankV2(g, 10, 30, 100, 0.85, 0.0001);
        assertEquals(res.getMaps().size(), 1, 0);
        assertEquals(res.getMap(1).size(), 1, 0);
    ...
    public void testTwoNodesGraph()
    {
        ...
        //no edges first
        PersonalizedPageRankAlgorithm res = new GuerrieriRankV2(g, 10, 
                100, 100, 0.85, 0.0001);
        ...
        res = new GuerrieriRankV2(g, 10, 10000, 100, 0.85, 0.0001);
    ...
    public void testLineGraph()
    {
        ...
        PersonalizedPageRankAlgorithm res = new GuerrieriRankV2(g, 10, 100, 100, 0.85, 0.0001);
    ...
    public void testStarGraph()
    {
        ...
        PersonalizedPageRankAlgorithm res = new GuerrieriRankV2(g, 10, 10, 10, 0.8, 0.0001);
        ...
        g.addEdge(0, 0);
        res = new GuerrieriRankV2(g, 10, 10, 10, 0.8, 0.0001);
    ...
    public void testNodesGreaterThanK1()
    {
        ...
        for(int i = 0; i < 99; i++)
            g.addEdge(i, i + 1);
        g.addEdge(99, 0);
        PersonalizedPageRankAlgorithm res = new GuerrieriRankV2(g, K, 10, 100, 0.8, 0.0001);
    ...
    public void testNodesGreaterThanK2()
    {
        ...
        for(int i = 0; i < 99; i++)
            g.addEdge(i, i + 1);
        g.addEdge(99, 0);
        PersonalizedPageRankAlgorithm res = new GuerrieriRankV2(g, K, 50, 100, 0.8, 0.0001);
    ...
    public void testNodesGreaterThanK3()
    {
        ...
        for(int i = 0; i < 99; i++)
            g.addEdge(i, i + 1);
        g.addEdge(99, 0);
        PersonalizedPageRankAlgorithm res = new GuerrieriRankV2(g, K, g.vertexSet().size()
                , 100, 0.8, 0.0001);
    ...
    public void testNodesGreaterThanK4()
    {
        ...
        for(int i = 0; i < 99; i++)
            g.addEdge(i, i + 1);
        g.addEdge(99, 0);
        PersonalizedPageRankAlgorithm res = new GuerrieriRankV2(g, K, g.vertexSet().size() * 2
                , 100, 0.8, 0.0001);
        g.addVertex(1000);
        for(int i = 0; i < 100; i++)
            assertTrue( res.getMap(i).size() == K);
